import { ADD_CALL, ADD_DEVICE, ADD_EXTERNAL_LOGIN, ADD_INCIDENT, ADD_NOTIFICATION, ADD_RESOLUTION, APPROVE_USER, ASSIGN_CREW, ASSIGN_USER_TO_CREW, CHANGE_PASSWORD, DELETE_DEVICE, DELETE_EDIT_INCIDENT, GET_ALL_DEVICES, GET_CALLS, GET_CLANS, GET_COORDINATES, GET_CREWS, GET_CURRENT_CREW, GET_DEVICES, GET_INCIDENTS, GET_NOTIFICATIONS, GET_RESOLUTION_FOR_INCIDENT, GET_UNAPPROVED_USERS, GET_USER_INFO, GET_WORK_REQUESTS, LOAD_DASHBOARD, LOGIN, LOGOUT, MARK_NOTIFICATIONS_READ, REFRESH_TOKEN, REGISTER, REMOVE_CURRENT_LOGGED, SAVE_BASIC_INFO, SAVE_CALLS, SAVE_CLANS, SAVE_CREWS, SAVE_CURRENT_CREW, SAVE_CURRENT_LOGGED, SAVE_DASHBOARD_DATA, SAVE_DETAILS, SAVE_DEVICES, SAVE_EDIT_INCIDENT, SAVE_INCIDENTS, SAVE_NOTIFICATIONS, SAVE_RESOLUTION_FOR_INCIDENT, SAVE_TOKEN, SAVE_UNAPPROVED_USERS, SAVE_WORK_REQUESTS, SORT_INCIDENTS, UPDATE_USER } from '../../constants/action-types'
...
export const AddExternalLogin = (payload) => {
    return { type: ADD_EXTERNAL_LOGIN, payload: payload }
}
...
export const SaveDashboardData = (payload) => {
    return { type: SAVE_DASHBOARD_DATA, payload: payload }
}